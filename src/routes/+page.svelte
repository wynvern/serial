   ...
   <Noise/>
	...
	<div class="absolute w-full p-4">
		<div class="border rounded w-full h-full bg-background">
			<div
				class="w-full h-full pl-6 p-2 flex items-center justify-between"
			>
				...
				<div class="flex gap-6 items-center">
                  ...
                  <a href="/support">
					...
					<a href="/signin"><Button><LogIn/>Entrar</Button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="flex flex-col gap-10 h-full w-full justify-center ml-10">
		<div class="flex flex-col gap-6">
            ...
            Mais um bot de propósito geral para o <i>Discord</i>, porém<br/>peludo e
            com nanites.
			</h2>
		</div>
		<div>
         <!-- Put the correct link to add the bot -->
			<Button class="w-48"><Plus />Me adicione!</Button> 
		</div>
	</div>

	<div class="absolute bottom-4 left-1/2 -translate-x-1/2">
		<a href="https://github.com/wynvern"><p class="text-xs text-muted-foreground">Desenvolvido por wynvern</p></a>
	</div>
</div>
